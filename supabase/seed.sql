...
values
  ...
  ('윤모습', '윤모습', '2001-04-26', 'F', '010-3333-4444', 'yoonms@example.com',
   '6조', 'devsalt', encode(digest('devsaltTESTA5', 'sha256'), 'hex')),
  ('엄태건', '엄태건', '2000-09-02', 'M', '010-5555-6666', 'etg@example.com',
   '1조', 'devsalt', encode(digest('devsaltTESTA6', 'sha256'), 'hex')),
